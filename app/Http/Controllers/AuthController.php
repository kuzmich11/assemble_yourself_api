...
//                return response(['message' => 'Пользователь успешно зарегистрирован'], 201);
    ...
    {
        $access_token = cookie('access_token', $token, auth()->factory()->getTTL() * 5, secure: true); //связанная настройка с config/jwt.php
        $refresh_token = cookie('refresh_token', $token, secure: true);
//            json([
//            'access_token' => $token,
//            'token_type' => 'bearer',
