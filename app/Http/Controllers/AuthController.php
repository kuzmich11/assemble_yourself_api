...
//            }
    ...
    {
        $access_token = cookie('access_token', $token, auth()->factory()->getTTL() * 5, domain: 'assemble-yourself-api.vercel.app', secure: true, httpOnly: false); //связанная настройка с config/jwt.php
        $refresh_token = cookie('refresh_token', $token, domain: 'assemble-yourself-api.vercel.app', secure: true, httpOnly: false);
//            json([
//            'access_token' => $token,
//            'token_type' => 'bearer',
